    ...
    <v-content>
      ...
      <section id="about-me">
        ...
        <v-container class="text-center">
          <h2 class="display-2 font-weight-bold mb-3">Le Rock et l'Art alternatif</h2>
...
Le rock alternatif est un genre musical, à base de guitare, basse et batterie, qui est apparu dans les années 1980. Il trouve ses origines dans le Post-punk, la new wave et le Garage rock. Le qualificatif " alternatif " vient du fait que beaucoup de groupes ont dû faire appel à des labels indépendants.
          </v-responsive>
          ...
          <v-avatar
            ...
            size="128"
          >
            <v-img src="uploads/serveimage2.jpeg"></v-img>
          </v-avatar>
